...
export default function RecipeFilters() {
  ...
  const hasActiveFilters = filters.cuisine || filters.diet || filters.maxReadyTime || filters.difficulty;
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        Filters
        {hasActiveFilters && <span className="w-2 h-2 rounded-full bg-brand-500" aria-label="Active filters" />}
      </button>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            {/* Cuisine */}
            <div>
              <label className="block text-xs font-semibold text-text-secondary uppercase tracking-wide mb-2">Cuisine</label>
            ...
            {/* Diet */}
            <div>
              <label className="block text-xs font-semibold text-text-secondary uppercase tracking-wide mb-2">Diet</label>
              <div className="flex flex-wrap gap-1.5">
                {DIETS.map((d) => (
                  <button key={d}
            ...
            {/* Difficulty — NEW */}
            <div>
              <label className="block text-xs font-semibold text-text-secondary uppercase tracking-wide mb-2">Difficulty</label>
              <div className="flex flex-wrap gap-1.5">
            ...
            {/* Cook time */}
            <div>
              <label className="block text-xs font-semibold text-text-secondary uppercase tracking-wide mb-2">Cook time</label>
              <div className="flex flex-wrap gap-1.5">
